package umn.ac.id.week07b_28501;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void isiDaftarVideo() {
        ...
        daftarVideo.add(new SumberVideo("Kejar-kejaran", "Kejar-kejaran di jalanan hasil cuplikan dari film TheFast and The Furious", "android.resource://" + getPackageName() + "/" + R.raw.drift02));
